...
//  Slot-Machine
//
//  Created by Luis Alejandro Umana Salas on 14/11/22.
//
    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .center, spacing: 80){
                ...
                HStack{
                    Text("Remaining attemps: \(counter)")
                        .fontWeight(.black)
                        .font(.system(size: 15))
                }
                VStack(spacing: 15){
                ...
                Button {
                    ...
                    self.numbers.forEach { number in
                        self.numbers[number] = Int.random(in: 0...self.symbols.count - 1)
                    }
            ...
            .alert(item: $showingAlert) { alert -> Alert in
                switch alert {
                case .sucess:
                    return Alert(title: Text("Yeahh you won!!"), message: Text("Born with de charm"), dismissButton: .cancel())
                case .failure:
                    return Alert(title: Text("Oooopsss !"), message: Text("Better luck next time"), dismissButton: .cancel())
                }
            }
        }
    }
